...
item_count = 0
page_count = 0
base = "http://search.jd.com/"
url = "http://search.jd.com/Search?keyword="
param = "&enc=utf-8&suggest=0"
...
#    )
    ...
    def parse(self, response):
        result_list = response.xpath('//li/div/div[@class="p-name"]/a[@target="_blank"]/@href').extract()
